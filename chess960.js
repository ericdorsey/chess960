...
function go() {
    ...
    drawOnBoard(rand_pos[0], drawing)
}
...
function specific_go() {
    ...
    //getspecificinput = Number(getspecificinput);
    console.log(typeof getspecificinput);
    console.log("getspecificinput in specific_go() is: " + getspecificinput);
    console.log("getspecificinput is " + getspecificinput)
    console.log(positions[getspecificinput]);
